\# Mon premier RAG — ChromaDB + sentence-transformers + Groq
...
1\. Qui intercepte : la classe Moderator, appelee en premier dans answer\_question(), avant tout

&#x20;  retrieval et tout appel au LLM principal.

2\. Sans moderateur : le contenu factuel reste globalement correct grace au prompt systeme strict,

&#x20;  mais le ton derape (digressions fantaisistes) : preuve que l'injection influence quand meme le

&#x20;  comportement du modele.

3\. Question hors corpus : le systeme respecte la consigne et dit qu'il ne trouve pas la reponse,

&#x20;  sans inventer.

4\. Affirmation fausse : le systeme signale la contradiction et donne la version correcte issue de

&#x20;  l'extrait, en citant la source.
