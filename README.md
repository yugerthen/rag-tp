...
- prompt_rag.txt / prompt_moderator.txt : prompts systeme externalises
...
1. Qui intercepte : la classe Moderator, appelee en premier dans answer_question(), avant tout retrieval et tout appel au LLM principal.
